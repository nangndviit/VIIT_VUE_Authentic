<template>
  <form method="get" action="https://authentic-shoes.com/collections/tat-ca-san-pham-giay-co-san/">
    <div class="price_slider_wrapper">
      ...
      <div class="price_slider_amount" data-step="10">
        ...
        <input type="text" id="max_price" name="max_price" value="490000000" data-max="490000000"
          placeholder="Giá cao nhất" style="display: none" />
        <button type="submit" class="button">Lọc</button>
        <div class="price_label" style="">
          Giá <span class="from">0 ₫</span> —
          <span class="to">490,000,000 ₫</span>
        </div>
        <div class="clear"></div>
      </div>
    </div>
